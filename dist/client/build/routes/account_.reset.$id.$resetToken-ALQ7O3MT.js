...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/account_.reset.$id.$resetToken.jsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695303548821.2556";
}
var meta = () => {
  return [{
...
//# sourceMappingURL=/build/routes/account_.reset.$id.$resetToken-ALQ7O3MT.js.map
