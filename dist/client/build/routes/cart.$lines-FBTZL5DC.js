...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/cart.$lines.jsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695303548277.2576";
}
function Component() {
  return null;
}
 ...
 * @preserve
 */
//# sourceMappingURL=/build/routes/cart.$lines-FBTZL5DC.js.map
