...
} from "/build/_shared/chunk-JJHRYXEG.js";
import {
  CartMain
...
// app/styles/app.css
var app_default = "/build/_assets/app-CDW3QMVT.css";
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695303507821.41";
}
function Aside({
  children,
  heading,
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1697652303904.72";
}
function Footer({
  menu
}) {
...
function FooterMenu({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_jsx_dev_runtime2.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("nav", { className: "footer-menu", role: "navigation", children: (menu || FALLBACK_FOOTER_MENU).items.map((item) => {
    if (!item.url)
      return null;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695303507945.41";
}
function Header({
  header,
  isLoggedIn,
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1695303863012.458";
}
function Layout({
  cart,
  children = null,
...
var tailwind_default = "/build/_assets/tailwind-PRR4BIUE.css";
...
_s3(App, "eSpv0U3Ug+ugZvjh8V2BqlN9nvU=", false, function() {
  return [ge, useLoaderData];
});
_c9 = App;
...
_s22(ErrorBoundary, "o5G7lII3qIcf5ddDZYv/3UI99ms=", false, function() {
  return [useRouteError, useMatches, ge];
});
_c25 = ErrorBoundary;
...
//# sourceMappingURL=/build/root-CKE5VXBV.js.map
